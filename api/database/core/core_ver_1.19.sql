...
-- Dumping data for table thrd.conversation_chats: ~14 rows (approximately)
...
INSERT INTO `personal_access_tokens` (`id`, `tokenable_type`, `tokenable_id`, `name`, `token`, `abilities`, `last_used_at`, `expires_at`, `created_at`, `updated_at`) VALUES
	...
	(18, 'App\\Models\\User', 86, 'auth_token', 'ceb6bb2142c9fc8fe69093ef4bafd1ef728d0c81398b53a93ca22c045bcc6f87', '["*"]', '2026-03-20 22:29:54', NULL, '2026-03-19 01:43:47', '2026-03-20 22:29:54');
...
CREATE TABLE IF NOT EXISTS `users_activity` (
  ...
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4283 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='- tracks the users activity';

-- Dumping data for table thrd.users_activity: ~40 rows (approximately)
