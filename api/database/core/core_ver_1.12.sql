...
CREATE TABLE IF NOT EXISTS `address` (
  ...
  `addr_street` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_zip` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_postal_code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_country` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_state` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_province` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_phone_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_area_code` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_city` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_street_num` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_apart_num` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_po_box` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_floor_num` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_unit` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_suite` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `addr_department` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `answers` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint DEFAULT NULL,
  `ua_ui_id` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ua_description` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ua_likes` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ua_dislikes` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ua_shares` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `file_store_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `carts` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned DEFAULT NULL,
  `cart_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `cities_canada` (
  ...
  `city_ascii` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `cities_us` (
  ...
  `city` varchar(44) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `city_ascii` varchar(44) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state_id` varchar(2) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `state_name` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `county_fips` int DEFAULT NULL,
  `county_name` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `military` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incorporated` varchar(5) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timezone` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ranking` int DEFAULT NULL,
  `zips` varchar(1847) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `comm_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_usr_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_comment_unique_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_comment` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_reply_an_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_is_reply` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT 'No',
  `comm_reply_parent_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_dislike` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Active',
  `comm_s_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'unread',
  `comm_like` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_ui_is_public` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_type_id` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_ui_is_read` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `comm_email` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `company_info` (
  ...
  `company_social_1` text COLLATE utf8mb4_unicode_ci,
  `company_social_2` text COLLATE utf8mb4_unicode_ci,
  `company_social_3` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `content_approvals` (
  ...
  `content_reason_table` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `approval_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_human_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_summary` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_desc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_second_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_third_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_op_1` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_op_2` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_op_3` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `approval_op_4` varchar(3000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `content_reporting` (
  ...
  `incident_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `reporting_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason_table` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_description` longtext COLLATE utf8mb4_unicode_ci,
  `reporting_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_threshold` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_threshold_count` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reporting_isAppealed` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'no',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `content_reporting_appeals` (
  ...
  `report_appeals_reason_desc` longtext COLLATE utf8mb4_unicode_ci,
  `report_appeals_response_desc` longtext COLLATE utf8mb4_unicode_ci,
  `report_appeals_decision` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_appeals_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_appeals_second_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_1` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_2` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_3` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `content_reporting_transaction_history` (
  ...
  `reason_id` bigint DEFAULT NULL,
  `reason_table` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `report_trans_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_trans_reason_desc` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_trans_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `report_trans_data` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `conversations` (
  ...
  `group_ids` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `conv_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` text COLLATE utf8mb4_unicode_ci,
  `deleted_by_user_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted_by_from_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `deleted_by_group_ids` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `status_second` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'couple',
  `type_second` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'couple',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `conversation_chats` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `init_user_id` bigint DEFAULT NULL,
  `end_user_id` bigint DEFAULT NULL,
  `conversation_id` bigint DEFAULT NULL,
  `chat_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` text COLLATE utf8mb4_unicode_ci,
  `attachment` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op1` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op2` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `seen_by_other_user` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `seen_by_received_user` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dumping structure for table thrd.conversation_group_tracker
DROP TABLE IF EXISTS `conversation_group_tracker`;
CREATE TABLE IF NOT EXISTS `conversation_group_tracker` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `convo_cat_id` int unsigned DEFAULT NULL,
  `convo_id` int unsigned DEFAULT NULL,
  `user_id` int unsigned DEFAULT NULL,
  `an_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracker_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracker_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tracker_order` int unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table thrd.conversation_group_tracker: ~0 rows (approximately)
/*!40000 ALTER TABLE `conversation_group_tracker` DISABLE KEYS */;
/*!40000 ALTER TABLE `conversation_group_tracker` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `core_site_config` (
  ...
  `cfg_option_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cfg_status` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_1` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_2` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_3` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_4` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_5` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_6` text COLLATE utf8mb4_unicode_ci,
  `cfg_value_7` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`cfg_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `credit_transactions` (
  ...
  `currency` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT 'usd',
...
CREATE TABLE IF NOT EXISTS `files_articles` (
  ...
  `table_reference_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_store_an_id` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filename` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foldername` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping structure for table thrd.files_credentials_stored
DROP TABLE IF EXISTS `files_credentials_stored`;
CREATE TABLE IF NOT EXISTS `files_credentials_stored` (
  `id` bigint NOT NULL DEFAULT '0',
  `user_id` bigint NOT NULL DEFAULT '0',
  `file_store_an_id` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `filename` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `foldername` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'active',
  `verify_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
...
-- Dumping data for table thrd.files_credentials_stored: ~0 rows (approximately)
/*!40000 ALTER TABLE `files_credentials_stored` DISABLE KEYS */;
/*!40000 ALTER TABLE `files_credentials_stored` ENABLE KEYS */;

-- Dumping structure for table thrd.files_mynetwork
DROP TABLE IF EXISTS `files_mynetwork`;
CREATE TABLE IF NOT EXISTS `files_mynetwork` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `reference_id` bigint unsigned NOT NULL,
  `table_reference_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_store_an_id` bigint unsigned DEFAULT NULL,
  `filename` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foldername` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `verify_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dumping data for table thrd.files_mynetwork: ~0 rows (approximately)
/*!40000 ALTER TABLE `files_mynetwork` DISABLE KEYS */;
/*!40000 ALTER TABLE `files_mynetwork` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `files_post_stored` (
  ...
  `foldername` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `verify_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'inactive',
  `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'image',
...
-- Dumping structure for table thrd.files_stored
...
CREATE TABLE IF NOT EXISTS `files_stored` (
  ...
  `foldername` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `verify_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'unverified',
  `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'image',
  `order` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `files_stored_file_store_an_id_index` (`file_store_an_id`),
  KEY `files_stored_file_store_wishlist_an_id_index` (`file_store_wishlist_an_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table thrd.files_stored: ~0 rows (approximately)
/*!40000 ALTER TABLE `files_stored` DISABLE KEYS */;
/*!40000 ALTER TABLE `files_stored` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `files_temporary` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `file_temp_an_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `filename` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foldername` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `image_test` (
  ...
  `original_image_public_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `original_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `generated_image_public_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `generated_image` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `operation_type` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
...
CREATE TABLE IF NOT EXISTS `incidents` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `incident_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_id` int DEFAULT NULL,
  `incident_target_reason_table` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_summary` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_data1` text COLLATE utf8mb4_unicode_ci,
  `incident_data2` text COLLATE utf8mb4_unicode_ci,
  `incident_data3` text COLLATE utf8mb4_unicode_ci,
  `incident_data4` text COLLATE utf8mb4_unicode_ci,
  `incident_data5` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `incidents_catalog` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `incident_name` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_rate` double DEFAULT NULL,
  `incident_priority` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_status` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_threshold` int DEFAULT NULL,
  `incident_op_1` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `incident_op_2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `job_posts` (
  ...
  `slug_trans` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_description` text COLLATE utf8mb4_unicode_ci,
  `meta_keywords` text COLLATE utf8mb4_unicode_ci,
  `status` enum('COMMITTED','UNPAID','UNPAID_TO_BE_PAID_DRAFT','UNPAID_TO_BE_PAID_DRAFT_REMOVED','DRAFT','ARCHIVED','REMOVED') COLLATE utf8mb4_unicode_ci DEFAULT 'DRAFT',
  ...
  `employer_type` enum('full-time','part-time','contractor','temporary','internship','per diem','volunteer','onsite') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `budget` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `salary_min` decimal(10,2) DEFAULT NULL,
  `salary_max` decimal(10,2) DEFAULT NULL,
  `payment_frequency` enum('milestone','hourly','one-time') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `primary_tag` enum('software development','customer service','sales','marketing','design','frontend','backend','legal','Quality assurance','testing','non-tech','other','JavaScript') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `secondary_tags` json DEFAULT NULL,
  `skills` json DEFAULT NULL,
  `location_type` enum('remote','on-site','hybrid') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_restriction` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_state_province` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_zip_postal` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_long` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `locaiton_lat` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `apply_email_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `company_twitter` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `invoice_notes_po_box_number` text COLLATE utf8mb4_unicode_ci,
  `feedback_box` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `knowledge_base` (
  ...
  `kb_an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_type1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_type2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_summary` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_description` text COLLATE utf8mb4_unicode_ci,
  `kb_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_views` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `kb_data` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `knowledge_base_pages` (
  `id` int NOT NULL AUTO_INCREMENT,
  `page_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `likes` (
  ...
  `item_id` bigint DEFAULT NULL,
  `pronetwork_group_profile_id` bigint DEFAULT NULL,
  `lk_status` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `lk_type` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT 'like',
  `lk_value` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  `note_table_name_target` longtext COLLATE utf8mb4_unicode_ci,
  `note_table_related_id` longtext COLLATE utf8mb4_unicode_ci,
  `note_relation_description` longtext COLLATE utf8mb4_unicode_ci,
  `op_1` longtext COLLATE utf8mb4_unicode_ci,
  `op_2` longtext COLLATE utf8mb4_unicode_ci,
  `op_3` longtext COLLATE utf8mb4_unicode_ci,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'new',
  `color_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'black',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `post_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file_store_an_id` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `body` longtext COLLATE utf8mb4_unicode_ci,
  `status` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT 'active',
  `type` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT 'general',
  `isVisible` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `shareLink` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `pronetwork` (
  ...
  `op_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_3` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_4` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op_5` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pronetwork_connections` (
  ...
  `an_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `initiator_user_id` bigint DEFAULT NULL,
  `accepter_user_id` bigint DEFAULT NULL,
  `isConnected` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `pronetwork_group_profile` (
  ...
  `general_headline` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `detailed_about` text COLLATE utf8mb4_unicode_ci,
  ...
  `social_media_link2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_media_link3` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_media_link4` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_media_link5` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `social_media_link6` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `views_count` int NOT NULL DEFAULT '0',
  `following_count` int NOT NULL DEFAULT '0',
  `contact_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `general_skills` text COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `pronetwork_requests` (
  ...
  `initiator_user_id` bigint DEFAULT NULL,
  `accepter_user_id` bigint DEFAULT NULL,
  `isAccepted` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'false',
  `status` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT '',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pronetwork_user_profile` (
  ...
  `header_image_id` bigint unsigned DEFAULT NULL,
  `profile_image_id` bigint unsigned DEFAULT NULL,
  `general_headline` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `detailed_about` text COLLATE utf8mb4_unicode_ci,
  `general_location_city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `general_location_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `general_location_state_province` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pronetwork_user_profile_education` (
  ...
  `location_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_state_province` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_state_province_abbrv` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pronetwork_user_profile_volunteering` (
  ...
  `user_id` bigint unsigned NOT NULL,
  `position` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volunteer_company` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_city` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_state_province` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rankings` (
  ...
  `rank_status` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_score` double DEFAULT NULL,
  `rank_weighed_score` double DEFAULT NULL,
  `rank_data` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ranking_groups` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rank_group_type` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_group_tier` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_group_order` int DEFAULT NULL,
  `rank_group_weighted_score_threshold` double DEFAULT NULL,
  `rank_group_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_group_data` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ranking_interaction_catalog` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rank_interact_name` varchar(1000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_interact_rate` double DEFAULT NULL,
  `rank_interact_type` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_interact_status` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_interact_passive_threshold` int DEFAULT NULL,
  `rank_interact_passive_reward` int DEFAULT NULL,
  `rank_interact_op_1` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_interact_op_2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ranking_permissions` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rank_perm_name` varchar(355) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_threshold` int DEFAULT NULL,
  `rank_perm_value` int DEFAULT NULL,
  `rank_perm_order` int DEFAULT NULL,
  `rank_perm_type1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_type2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_status` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_limit_duration` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_op2` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_perm_op3` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `ranking_transaction_history` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rank_trans_an_id` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_interact_id` bigint DEFAULT NULL,
  `rank_id` bigint DEFAULT NULL,
  `user_id` bigint DEFAULT NULL,
  `reason_id` bigint DEFAULT NULL,
  `reason_table` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_reason_desc` varchar(5000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_initiator` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_name` varchar(300) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_group` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_start_rank` double DEFAULT NULL,
  `rank_trans_direction` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_amount` double DEFAULT NULL,
  `rank_trans_end_rank` double DEFAULT NULL,
  `rank_trans_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_threshold` int DEFAULT NULL,
  `rank_trans_threshold_count` int DEFAULT NULL,
  `rank_trans_trigger` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `rank_trans_data` varchar(2000) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ranking_weight` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `rank_weight_name` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `roles` (`id`, `name`, `display_name`, `created_at`, `updated_at`) VALUES
	...
	(4, 'user', 'Personal', '2026-03-05 00:00:50', '2026-03-05 00:00:51'),
	(5, 'host', 'Community Host', '2026-03-05 00:01:50', '2026-03-05 00:01:52'),
	(6, 'venue', 'Business Venue', '2026-03-05 00:01:51', '2026-03-05 00:01:52');
...
CREATE TABLE IF NOT EXISTS `search` (
  ...
  `result_num` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `settings_site` (
  ...
  `type1` text COLLATE utf8mb4_unicode_ci,
  `type2` text COLLATE utf8mb4_unicode_ci,
  `description` text COLLATE utf8mb4_unicode_ci,
  `op4` text COLLATE utf8mb4_unicode_ci,
  `op5` text COLLATE utf8mb4_unicode_ci,
  `op6` text COLLATE utf8mb4_unicode_ci,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `subscriptions` (
  ...
  `isSubberSubbed` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op1` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `op2` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tracker_comment_user_video` (
  ...
  `tcuvt_up_vote` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `tcuvt_down_vote` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `tracker_playlist_video` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint DEFAULT NULL,
  `plylst_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plylst_an_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `plylst_description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `plylst_video_data` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `plylst_date_last_mod` datetime NOT NULL,
  `plylst_date_created` datetime NOT NULL,
  `plylst_status` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `plylst_access` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Public',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tracker_series_video` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `user_id` bigint DEFAULT NULL,
  `series_user_an_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_an_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_video_data` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_date_last_mod` datetime NOT NULL,
  `series_date_created` datetime NOT NULL,
  `series_status` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Active',
  `series_access` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Public',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `tracker_thumb_vote_video` (
  ...
  `user_id` bigint DEFAULT NULL,
  `video_id` bigint DEFAULT NULL,
  `tlut_up_vote` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `tlut_down_vote` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `tracker_user_content_history` (
  ...
  `his_json_history_record` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trxn_currency` (
  ...
  `sign` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trxn_order` (
  ...
  `currency_sign` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency_name` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `affilate_users` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `trxn_order_item` (
  ...
  `shipping` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pickup_location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `totalQty` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `affilate_user` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `affilate_charge` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `tax_location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `trxn_payment_processor` (
  ...
  `type` enum('manual','automatic') COLLATE utf8mb4_unicode_ci DEFAULT 'manual',
  `information` longtext COLLATE utf8mb4_unicode_ci,
  `keyword` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_id` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `trxn_product` (
  ...
  `size_all` text COLLATE utf8mb4_unicode_ci,
  ...
  `type` enum('Physical','Digital','License') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `trxn_shopping_cart` (
  ...
  `expire_threshold` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '30',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `role_id`, `alpha_num_id`, `firstname`, `lastname`, `username`, `name`, `email`, `google_id`, `profile_photo_path`, `avatar`, `email_verification_token`, `user_IsVerified`, `email_IsVerified`, `email_VerifiedToken`, `change_PasswordToken`, `password`, `password_try`, `status`, `credits`, `remember_token`, `settings`, `user_settings`, `type`, `telephone`, `about`, `contact`, `links`, `history`, `friend_list`, `vid_fav`, `circle_fav`, `phone_num`, `isStoreOpen`, `identity`, `intrests`, `yourLocation`, `who_i_sub_to`, `who_sub_to_me`, `who_i_sub_to_count`, `who_sub_to_me_count`, `registerIP`, `lastLoginIP`, `suspend_reactive`, `email_verified_at`, `birthdate`, `last_login`, `user_lat`, `user_long`, `user_city`, `default_km_range`, `language`, `searchable`, `updated_at`, `created_at`) VALUES
	...
	(3, 20, NULL, NULL, NULL, NULL, 'test', 'codnerk@gmail.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$pYeBnFm1dOZcb8.CeT19z.vvo9Nn2P0ZJeSnTovSVjcb0//4WYsdO', NULL, 'active', '100', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-01 03:57:59', '2026-02-23 20:28:08'),
	(4, 20, NULL, NULL, NULL, NULL, 'Laravel', 'test@test.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$IJ8RzbKMvWIWr21RvC6Nt.wg7H/p3OTV1u7KtoDCEClxMcldgmBrq', NULL, 'active', '100', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-02-25 05:54:09', '2026-02-25 05:54:09'),
	(5, 20, NULL, NULL, NULL, NULL, 'James', 'test@test.coms', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$cpu619LB6Em5O3pgWc3RFOO1231NKCQvRJkp3wXxsrgubbA2Wb8Ze', NULL, 'active', '100', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', '2026-02-25 06:24:29', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-02-25 06:24:29', '2026-02-25 06:24:20'),
	(80, 20, NULL, NULL, NULL, NULL, 'Tes', 'eheheh@jjj.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$C9PMnKbj51WGHfdrrUSsbuypCU6.F54PHyQjMJ05Dm5txq7gUeJNS', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 05:46:09', '2026-03-06 05:46:09'),
	(81, 20, NULL, NULL, NULL, NULL, 'Tes', 'aaaaaaa@jjj.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$VOjrxpJR2.zLheQod2mCk.ouTCFCnvJej05BP0Mzb0to5qd8noYbi', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 05:47:03', '2026-03-06 05:47:03'),
	(82, 20, NULL, NULL, NULL, NULL, 'Teat', 'teat@mega.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$zg6G8gY58DQW2/6JedhmK.bME5NR2CGX6ef0wPT3wKkT0sEZbqtOy', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 05:53:17', '2026-03-06 05:53:17'),
	(83, 20, NULL, NULL, NULL, NULL, 'Test', 'test@outlook.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$Dg/aKKkJ5UiXXNj1jHHOSOhUiywGT65sg2WOKIptMCTiZWiKDvXz2', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 05:55:13', '2026-03-06 05:55:13'),
	(84, 20, NULL, NULL, NULL, NULL, 'Test', 'tests@outlook.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$I7QUOOiNkFdqaRG0L3N1huVs/wEK8Z.n/KsrOluxWhZ8zRtl8vDI6', NULL, 'active', 'active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 06:00:00', '2026-03-06 06:00:00'),
	(85, 20, NULL, NULL, NULL, NULL, 'Test', 'testsggg@outlook.com', NULL, NULL, 'users/avatar.png', 'no', 'no', 'no', NULL, NULL, '$2y$12$zLGyDkI/Uw62llRoodOaCOs9n1GMcvDbhergH6eDmkVX7Sjra.9j6', NULL, 'active', 'active', NULL, NULL, NULL, 'personal', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '28994613136', NULL, 'anonymous', NULL, NULL, NULL, NULL, '0', '0', NULL, NULL, '1993-02-14 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'false', '2026-03-06 06:02:37', '2026-03-06 06:02:37');
...
CREATE TABLE IF NOT EXISTS `verify_images` (
  ...
  `reason_table` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image_status_1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image_status_2` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `videos` (
  ...
  `video_external_id` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_title` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `video_web_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_category` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_size` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_hits` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `video_likes` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `video_dislikes` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `video_shares` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `video_tags` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_status` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Active',
  `video_access` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'Public',
  `video_privacy` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'None',
  `video_inStore` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'No',
  `video_price` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT '$0.00',
  `video_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'codr license',
  `video_isSeries` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_series_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_series_num` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_series_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_datecreated` timestamp NULL DEFAULT NULL,
  `video_thumbnail_name` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_duration` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '00:00',
  `video_resolution_x` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `video_resolution_y` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `video_bitrate` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT '1',
  `video_allow_comments` varchar(15) COLLATE utf8mb4_unicode_ci DEFAULT 'Yes',
  `video_approval` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Not Approved',
  `video_is_this_refuted` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_rejection_date` datetime NOT NULL,
  `video_claim_dispute_reason` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `video_successful_or_failure_refute_date` datetime NOT NULL,
  `video_final_dispute_statement` varchar(1000) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
