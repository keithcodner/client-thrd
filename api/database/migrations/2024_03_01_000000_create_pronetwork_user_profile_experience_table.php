...
class CreatePronetworkUserProfileExperienceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pronetwork_user_profile_experience', function (Blueprint $table) {
            ...
            $table->string('company', 255)->nullable(); // VARCHAR(255), nullable
    ...
    {
        Schema::dropIfExists('pronetwork_user_profile_experience');
    }
}
