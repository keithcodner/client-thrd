...
class CreateTrxnAddressShippingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trxn_address_shipping', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('trxn_address_shipping');
    }
}
