...
class AddressBillingController extends Controller
{
    ...
    public function createAddressBillingTransaction($cartObj)
    {
        ...
        $addressBillingPaymentTransaction = PaymentTransactionAddressBilling::create([
            "user_id" => auth()->user()->id,
            "addr_street" => $cartObj['data']['addressBilling']['address1'],
            "addr_zip" => $cartObj['data']['addressBilling']['zip'],
            "addr_postal_code" => $cartObj['data']['addressBilling']['zip'],
            "addr_country" => $cartObj['data']['addressBilling']['country'],
            "addr_province" => $cartObj['data']['addressBilling']['state'],
            "addr_state" => $cartObj['data']['addressBilling']['state'],
            "addr_city" => $cartObj['data']['addressBilling']['city'], // need city
            //"addr_unit" => $cartObj['data']['addressBilling']['unit'],
        ]); 

        return $addressBillingPaymentTransaction;
    }
}
