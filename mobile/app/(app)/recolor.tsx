...
export default function Recolour() {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await axiosInstance.post('/image/recolour', formData, {
                headers: {
            ...
            if (axios.isAxiosError(error)) {
                ...
                console.error('Unexpected error:', error);
                Alert.alert('Error', 'Failed to recolour the image. Please try again.');
            }
        } finally {
            setIsLoading(false);
        }
                        ...
                        <View className="w-full">
                            ...
                            <View className="w-full mb-4 bg-gray-100 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                <Text className="text-gray-700 dark:text-gray-300 mb-2">
                                    What part of the image do you want to recolor?
                                </Text>
                                ...
                                <View className="flex-row flex-wrap mb-6">
                                    {predefinedColors.map((color) => (
                                        ...
                                        style={{
                                            ...
                                            borderColor: selectedColor === color ? colours.primary : '#ccc'
                                        }}
                                        activeOpacity={0.7}
                                        />
                                    ))}
